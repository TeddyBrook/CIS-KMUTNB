...
function View_obe5() {
    ...
    useEffect(() => {
        fetch('http://localhost:8081/api/pdfobe5')
            .then(response => response.json())
            .then(data => {
                setDocuments(data)
                console.log(data);
            })
            .catch(error => console.error('Error fetching PDF Outcome-based Education 5 :', error));
    }, []);
                ...
                <div className="document-bar">
                    ...
                    <div className="title-obe">
                        ...
                        {filteredDocuments.map(doc => (
                            <div key={doc.obe5document_Id} className="document-item">
                                <p> {doc.fileName} </p>
